    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: const LinearGradient(
          colors: [Color(0xFFE0EAFC), Color.fromARGB(255, 46, 131, 50)],
        ),
      ),
      child: Row(
  ...
  final List<Map<String, dynamic>> freelancers = [
    {
      ...
      "profession": "Shop",
      "rating": 4.9,
      "image": "assets/images/poster1.jpeg"
    },
    {
      "name": "M.U 2D",
      "profession": "Shop",
      "rating": 4.9,
      "image": "assets/images/poster2.jpeg"
    },
    {
      "name": "Championship",
      "profession": "Shop",
      "rating": 4.9,
      "image": "assets/images/poster3.jpeg"
    },
    {
      "name": "teamviewer",
      "profession": "Shop",
      "rating": 4.9,
      "image": "assets/images/poster4.jpeg"
    },
  ];
    ...
    return Column(
      children: [
        ...
        ServiceCard(
          ...
          name: 'Baju M.U Home',
          role: 'Home 2023/2024',
          description: 'Manchester United kit Home',
          rating: 4.9,
        ),
        ServiceCard(
          ...
          name: 'Baju Training',
          role: 'Traininh shirt',
          description: 'Manchester United training kit',
          rating: 4.9,
        ),
        ServiceCard(
          imageUrl: 'assets/images/p3.jpeg',
          name: 'Shock Manchester United',
          role: 'Shock',
          description: 'Shock Manchester United',
          rating: 4.9,
        ),
      ],
    );
  ...
  Widget build(BuildContext context) {
    return Column(
        children: [
          BestBookingCard(
            imageUrl: 'assets/images/p1.jpeg',
            profileUrl: 'assets/images/a.jpeg',
            name: 'Manchester United',
            role: 'kit',
            description: 'kit 2023/2024',
            rating: 4.9,
          ),
            ...
            child: Row(
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.star, color: const Color.fromARGB(255, 46, 131, 50), size: 16),
                      SizedBox(width: 4),
                      Text(
                        rating.toString(),
                        style: TextStyle(
            ...
            Stack(
              children: [
                ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/a1.jpeg', // Ganti dengan path gambar Anda
                    height: 230,
                    width: double.infinity,
                    fit: BoxFit.cover,
                  ),
